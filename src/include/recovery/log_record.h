...
class LogRecord {
 ...
 public:
  ...
  // constructor for Transaction type(BEGIN/COMMIT/ABORT) 事务开始、提交、终止
  ...
  // constructor for INSERT/DELETE type 插入、删除
  ...
  // constructor for UPDATE type 更新
  ...
  // constructor for NEWPAGE type 新页
