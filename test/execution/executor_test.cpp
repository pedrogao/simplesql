...
// NOLINTNEXTLINE
TEST_F(ExecutorTest, SimpleSeqScanLimitTest) {
  // SELECT colA, colB FROM test_1 WHERE colA < 500 limit 10 offset 10
  ...
  std::unique_ptr<LimitPlanNode> limit_plan = std::make_unique<LimitPlanNode>(out_schema, &plan, 10, 10);
